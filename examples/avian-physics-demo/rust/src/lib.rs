...
//     mut query: Query<(&mut Transform, &Position, &Rotation), With<SimpleBoxTag>>,
// ) -> Result {
//     if let Ok((transform, position, rotation)) = query.single_mut() {
...
//         if transform.translation != position.f32() {
//             panic!("wtf");
//         }
//         if transform.rotation != rotation.f32() {
//             panic!("wtf");
//         }
//
...
// fn simple_move(mut query: Query<&mut Transform, With<SimpleBoxTag>>) -> Result {
// fn simple_move(
//     mut query: Query<(&mut Transform, &mut GodotNodeHandle), With<Node3DMarker>>,
// ) -> Result {
...
// fn print_avian_physics(
//     mut query: Query<(&mut Transform, &Position, &Rotation), With<SimpleBoxTag>>,
// ) -> Result {
//     if let Ok((transform, position, rotation)) = query.single_mut() {
//         godot_print!("{transform:?}, {position:?}, {rotation:?}");
//     }
//
//     Ok(())
// }
