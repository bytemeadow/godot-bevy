...
fn check_3d_node_types_comprehensive(
    ...
    if node.try_get::<godot::classes::AudioStreamPlayer3D>().is_some() {
        entity_commands.insert(AudioStreamPlayer3DMarker);
    }
    ...
    if node.try_get::<godot::classes::CollisionObject3D>().is_some() {
        entity_commands.insert(CollisionObject3DMarker);
    }
    if node.try_get::<godot::classes::CollisionPolygon3D>().is_some() {
        entity_commands.insert(CollisionPolygon3DMarker);
    }
    ...
    if node.try_get::<godot::classes::ConvertTransformModifier3D>().is_some() {
        entity_commands.insert(ConvertTransformModifier3DMarker);
    }
    if node.try_get::<godot::classes::CopyTransformModifier3D>().is_some() {
        entity_commands.insert(CopyTransformModifier3DMarker);
    }
    if node.try_get::<godot::classes::Decal>().is_some() {
        entity_commands.insert(DecalMarker);
    }
    if node.try_get::<godot::classes::DirectionalLight3D>().is_some() {
        entity_commands.insert(DirectionalLight3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticles3D>().is_some() {
        entity_commands.insert(GPUParticles3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticlesAttractor3D>().is_some() {
        entity_commands.insert(GPUParticlesAttractor3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticlesAttractorBox3D>().is_some() {
        entity_commands.insert(GPUParticlesAttractorBox3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticlesAttractorSphere3D>().is_some() {
        entity_commands.insert(GPUParticlesAttractorSphere3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticlesAttractorVectorField3D>().is_some() {
        entity_commands.insert(GPUParticlesAttractorVectorField3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticlesCollision3D>().is_some() {
        entity_commands.insert(GPUParticlesCollision3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticlesCollisionBox3D>().is_some() {
        entity_commands.insert(GPUParticlesCollisionBox3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticlesCollisionHeightField3D>().is_some() {
        entity_commands.insert(GPUParticlesCollisionHeightField3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticlesCollisionSdf3d>().is_some() {
        entity_commands.insert(GPUParticlesCollisionSDF3DMarker);
    }
    if node.try_get::<godot::classes::GpuParticlesCollisionSphere3D>().is_some() {
        entity_commands.insert(GPUParticlesCollisionSphere3DMarker);
    }
    if node.try_get::<godot::classes::Generic6DofJoint3D>().is_some() {
        entity_commands.insert(Generic6DOFJoint3DMarker);
    }
    if node.try_get::<godot::classes::GeometryInstance3D>().is_some() {
        entity_commands.insert(GeometryInstance3DMarker);
    }
    ...
    if node.try_get::<godot::classes::ModifierBoneTarget3D>().is_some() {
        entity_commands.insert(ModifierBoneTarget3DMarker);
    }
    if node.try_get::<godot::classes::MultiMeshInstance3D>().is_some() {
        entity_commands.insert(MultiMeshInstance3DMarker);
    }
    if node.try_get::<godot::classes::OccluderInstance3D>().is_some() {
        entity_commands.insert(OccluderInstance3DMarker);
    }
    if node.try_get::<godot::classes::OmniLight3D>().is_some() {
        entity_commands.insert(OmniLight3DMarker);
    }
    if node.try_get::<godot::classes::OpenXrRenderModel>().is_some() {
        entity_commands.insert(OpenXRRenderModelMarker);
    }
    if node.try_get::<godot::classes::OpenXrRenderModelManager>().is_some() {
        entity_commands.insert(OpenXRRenderModelManagerMarker);
    }
    ...
    if node.try_get::<godot::classes::PhysicalBoneSimulator3D>().is_some() {
        entity_commands.insert(PhysicalBoneSimulator3DMarker);
    }
    ...
    if node.try_get::<godot::classes::RemoteTransform3D>().is_some() {
        entity_commands.insert(RemoteTransform3DMarker);
    }
    #[cfg(feature = "api-4-4")]
    if node.try_get::<godot::classes::RetargetModifier3D>().is_some() {
        entity_commands.insert(RetargetModifier3DMarker);
    }
    ...
    if node.try_get::<godot::classes::SkeletonModifier3D>().is_some() {
        entity_commands.insert(SkeletonModifier3DMarker);
    }
    ...
    #[cfg(feature = "api-4-4")]
    if node.try_get::<godot::classes::SpringBoneCollision3D>().is_some() {
        entity_commands.insert(SpringBoneCollision3DMarker);
    }
    #[cfg(feature = "api-4-4")]
    if node.try_get::<godot::classes::SpringBoneCollisionCapsule3D>().is_some() {
        entity_commands.insert(SpringBoneCollisionCapsule3DMarker);
    }
    #[cfg(feature = "api-4-4")]
    if node.try_get::<godot::classes::SpringBoneCollisionPlane3D>().is_some() {
        entity_commands.insert(SpringBoneCollisionPlane3DMarker);
    }
    #[cfg(feature = "api-4-4")]
    if node.try_get::<godot::classes::SpringBoneCollisionSphere3D>().is_some() {
        entity_commands.insert(SpringBoneCollisionSphere3DMarker);
    }
    #[cfg(feature = "api-4-4")]
    if node.try_get::<godot::classes::SpringBoneSimulator3D>().is_some() {
        entity_commands.insert(SpringBoneSimulator3DMarker);
    }
    ...
    if node.try_get::<godot::classes::VisibleOnScreenEnabler3D>().is_some() {
        entity_commands.insert(VisibleOnScreenEnabler3DMarker);
    }
    if node.try_get::<godot::classes::VisibleOnScreenNotifier3D>().is_some() {
        entity_commands.insert(VisibleOnScreenNotifier3DMarker);
    }
...
fn check_2d_node_types_comprehensive(
    ...
    if node.try_get::<godot::classes::AudioStreamPlayer2D>().is_some() {
        entity_commands.insert(AudioStreamPlayer2DMarker);
    }
    ...
    if node.try_get::<godot::classes::CollisionObject2D>().is_some() {
        entity_commands.insert(CollisionObject2DMarker);
    }
    if node.try_get::<godot::classes::CollisionPolygon2D>().is_some() {
        entity_commands.insert(CollisionPolygon2DMarker);
    }
    if node.try_get::<godot::classes::CollisionShape2D>().is_some() {
        entity_commands.insert(CollisionShape2DMarker);
    }
    if node.try_get::<godot::classes::DampedSpringJoint2D>().is_some() {
        entity_commands.insert(DampedSpringJoint2DMarker);
    }
    if node.try_get::<godot::classes::DirectionalLight2D>().is_some() {
        entity_commands.insert(DirectionalLight2DMarker);
    }
    ...
    if node.try_get::<godot::classes::MultiMeshInstance2D>().is_some() {
        entity_commands.insert(MultiMeshInstance2DMarker);
    }
    ...
    if node.try_get::<godot::classes::RemoteTransform2D>().is_some() {
        entity_commands.insert(RemoteTransform2DMarker);
    }
    ...
    if node.try_get::<godot::classes::TouchScreenButton>().is_some() {
        entity_commands.insert(TouchScreenButtonMarker);
    }
    if node.try_get::<godot::classes::VisibleOnScreenEnabler2D>().is_some() {
        entity_commands.insert(VisibleOnScreenEnabler2DMarker);
    }
    if node.try_get::<godot::classes::VisibleOnScreenNotifier2D>().is_some() {
        entity_commands.insert(VisibleOnScreenNotifier2DMarker);
    }
}
...
fn check_control_node_types_comprehensive(
    ...
    if node.try_get::<godot::classes::AspectRatioContainer>().is_some() {
        entity_commands.insert(AspectRatioContainerMarker);
    }
    ...
    if node.try_get::<godot::classes::ColorPickerButton>().is_some() {
        entity_commands.insert(ColorPickerButtonMarker);
    }
    ...
    if node.try_get::<godot::classes::FoldableContainer>().is_some() {
        entity_commands.insert(FoldableContainerMarker);
    }
    ...
    if node.try_get::<godot::classes::SubViewportContainer>().is_some() {
        entity_commands.insert(SubViewportContainerMarker);
    }
    ...
    if node.try_get::<godot::classes::TextureProgressBar>().is_some() {
        entity_commands.insert(TextureProgressBarMarker);
    }
    ...
    if node.try_get::<godot::classes::VideoStreamPlayer>().is_some() {
        entity_commands.insert(VideoStreamPlayerMarker);
    }
}
...
fn check_universal_node_types_comprehensive(
    ...
    if node.try_get::<godot::classes::AudioStreamPlayer>().is_some() {
        entity_commands.insert(AudioStreamPlayerMarker);
    }
    ...
    if node.try_get::<godot::classes::InstancePlaceholder>().is_some() {
        entity_commands.insert(InstancePlaceholderMarker);
    }
    if node.try_get::<godot::classes::MultiplayerSpawner>().is_some() {
        entity_commands.insert(MultiplayerSpawnerMarker);
    }
    if node.try_get::<godot::classes::MultiplayerSynchronizer>().is_some() {
        entity_commands.insert(MultiplayerSynchronizerMarker);
    }
    if node.try_get::<godot::classes::Node3D>().is_some() {
        entity_commands.insert(Node3DMarker);
    }
    if node.try_get::<godot::classes::ResourcePreloader>().is_some() {
        entity_commands.insert(ResourcePreloaderMarker);
    }
    if node.try_get::<godot::classes::ShaderGlobalsOverride>().is_some() {
        entity_commands.insert(ShaderGlobalsOverrideMarker);
    }
