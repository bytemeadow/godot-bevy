...
impl GraphEditSignals {
    ...
    /// Emitted when this  captures a `ui_copy` action (Ctrl + C by default). In general, this signal indicates that the selected s should be copied.
    pub const COPY_NODES_REQUEST: &'static str = "copy_nodes_request";

    /// Emitted when this  captures a `ui_cut` action (Ctrl + X by default). In general, this signal indicates that the selected s should be cut.
    pub const CUT_NODES_REQUEST: &'static str = "cut_nodes_request";

    /// Emitted when this  captures a `ui_paste` action (Ctrl + V by default). In general, this signal indicates that previously copied s should be pasted.
    pub const PASTE_NODES_REQUEST: &'static str = "paste_nodes_request";

    /// Emitted when this  captures a `ui_graph_duplicate` action (Ctrl + D by default). In general, this signal indicates that the selected s should be duplicated.
    pub const DUPLICATE_NODES_REQUEST: &'static str = "duplicate_nodes_request";

    /// Emitted when this  captures a `ui_graph_delete` action (Delete by default).
    ...
    /// Emitted when the given  node is selected.
    pub const NODE_SELECTED: &'static str = "node_selected";

    /// Emitted when the given  node is deselected.
    pub const NODE_DESELECTED: &'static str = "node_deselected";

    /// Emitted when the  `frame` is resized to `new_rect`.
    pub const FRAME_RECT_CHANGED: &'static str = "frame_rect_changed";
    ...
    /// Emitted at the beginning of a 's movement.
    pub const BEGIN_NODE_MOVE: &'static str = "begin_node_move";

    /// Emitted at the end of a 's movement.
    pub const END_NODE_MOVE: &'static str = "end_node_move";

    /// Emitted when one or more s are dropped onto the  named `frame`, when they were not previously attached to any other one.
    /// `elements` is an array of s to be attached.
    pub const GRAPH_ELEMENTS_LINKED_TO_FRAME_REQUEST: &'static str =
        "graph_elements_linked_to_frame_request";
...
#[cfg(feature = "experimental-godot-api")]
/// Signal constants for `GraphFrame`
pub struct GraphFrameSignals;

#[cfg(feature = "experimental-godot-api")]
impl GraphFrameSignals {
    /// Emitted when `autoshrink_enabled` or `autoshrink_margin` changes.
    pub const AUTOSHRINK_CHANGED: &'static str = "autoshrink_changed";
}
...
impl GraphElementSignals {
    ...
    pub const RESIZE_END: &'static str = "resize_end";
...
/// Signal constants for `StatusIndicator`
pub struct StatusIndicatorSignals;

impl StatusIndicatorSignals {
...
/// Signal constants for `OpenXrBindingModifierEditor`
pub struct OpenXrBindingModifierEditorSignals;

impl OpenXrBindingModifierEditorSignals {
    /// Signal emitted when the user presses the delete binding modifier button for this modifier.
    pub const BINDING_MODIFIER_REMOVED: &'static str = "binding_modifier_removed";
}
...
impl FileSystemDockSignals {
    ...
    pub const FOLDER_COLOR_CHANGED: &'static str = "folder_color_changed";
...
/// Signal constants for `EditorDock`
pub struct EditorDockSignals;

impl EditorDockSignals {
...
/// Signal constants for `OpenXrPlaneTracker`
pub struct OpenXrPlaneTrackerSignals;

impl OpenXrPlaneTrackerSignals {
    /// Emitted when our mesh data has changed the mesh instance and collision needs to be updated.
    pub const MESH_CHANGED: &'static str = "mesh_changed";
}

/// Signal constants for `OpenXrAnchorTracker`
pub struct OpenXrAnchorTrackerSignals;

impl OpenXrAnchorTrackerSignals {
    /// Emitted when the UUID for this anchor was changed.
    pub const UUID_CHANGED: &'static str = "uuid_changed";
}

/// Signal constants for `OpenXrSpatialEntityTracker`
pub struct OpenXrSpatialEntityTrackerSignals;

impl OpenXrSpatialEntityTrackerSignals {
    /// Signal `spatial_tracking_state_changed`
    pub const SPATIAL_TRACKING_STATE_CHANGED: &'static str = "spatial_tracking_state_changed";
}

/// Signal constants for `OpenXrSpatialEntityExtension`
pub struct OpenXrSpatialEntityExtensionSignals;

impl OpenXrSpatialEntityExtensionSignals {
    ...
    pub const SPATIAL_DISCOVERY_RECOMMENDED: &'static str = "spatial_discovery_recommended";
}
...
impl WindowSignals {
    ...
    pub const NONCLIENT_WINDOW_INPUT: &'static str = "nonclient_window_input";
...
impl GraphNodeSignals {
    ...
    pub const SLOT_SIZES_CHANGED: &'static str = "slot_sizes_changed";
}
