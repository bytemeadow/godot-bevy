...
The launcher (`examples/run_godot.rs`, via `cargo-godot-lib`) generates each example's gitignored `godot/rust.gdextension`; building the library alone does not create it. CI writes the descriptor before importing and exporting.
