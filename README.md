...
- **Automatic Component Generation**: Use `#[derive(BevyComponent)]` to automatically generate Bevy components from a `GodotClass` with exported properties
...
- **[Automatic Component Generation](docs/COMPONENT_GENERATION.md)** - Eliminate boilerplate with auto-generated Bevy components from a `GodotClass` with exported properties
