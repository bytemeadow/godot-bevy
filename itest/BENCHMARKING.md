...
| `transform_sync_godot_to_bevy_3d` | Godot->Bevy 3D sync (FixedFirst schedule, primary per-step read) |
...
| `transform_sync_godot_to_bevy_2d` | Godot->Bevy 2D sync (FixedFirst schedule, primary per-step read) |
