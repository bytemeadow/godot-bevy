...
- [Macro redesign — `#[bevy(...)]` unified grammar (breaking change)](#macro-redesign--bevy-unified-grammar-breaking-change)
...
## Macro Redesign — `#[bevy(...)]` Unified Grammar (Breaking Change)
...
- Replace `#[bevy_bundle((Marker), (Comp: field))]` with `#[bevy(require(Marker))]` at the struct level and `#[bevy(component = Comp)]` at the field level.
- Replace `#[bevy_bundle(transform_with = "fn")]` with `#[bevy(with = fn)]` (unquoted path, not a string).
...
```rust
#[bevy(require(Comp { bevy_field: godot_field, … }))]
```
...
- Replace `#[godot_node(base(…), class_name(…))]` with `#[bevy(base = …, class_name = …)]`.
...
- [ ] Replace `#[bevy_bundle(...)]` struct attributes with `#[bevy(require(...))]`.
- [ ] Replace `#[bevy_bundle(transform_with = "fn")]` with `#[bevy(with = fn)]` (no quotes).
- [ ] Replace bundle-mode `#[derive(Bundle, GodotNode)]` + `#[export_fields]` with component-first
      `#[derive(Component, GodotNode, Default)]` + `require(...)`.
- [ ] Replace `#[godot_node(base(…), class_name(…))]` with `#[bevy(base = …, class_name = …)]`.
- [ ] Replace `#[godot_export(default(…))]` with `#[bevy(default = …)]`.
